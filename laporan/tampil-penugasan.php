...
<br>
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title">Data Penugasan <?php echo $_SESSION['id_user'] ." - ". $_SESSION['level']; ?></h3>
            </div>
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            $jumlah_record = mysqli_query($db, "SELECT * from penugasan where id_user=$idu ") or die('Ada kesalahan pada query jumlah_record: ' . mysqli_error($db));
                            ...
                            $query = mysqli_query($db, "SELECT * from penugasan WHERE id_user=$idu ORDER BY id_penugasan LIMIT $mulai, $batas  ") or die('Ada kesalahan pada query penugasan: ' . mysqli_error($db));
                      ...
                      <td width='150'>$data[id_perjalanan]</td>
                      <td width='150'>$data[id_user]</td>
