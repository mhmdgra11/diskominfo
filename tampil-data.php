            ...
            <tbody>
              ...
              if (isset($cari)) {
                $jumlah_record = mysqli_query($db, "SELECT * FROM user
                                                    WHERE id_user LIKE '%$cari%' OR username LIKE '%$cari%'")
              ...
              while ($data = mysqli_fetch_assoc($query)) {
                ...
                echo "  <tr>
                      ...
                      <td width='100' class='center'>
                        ...
                        <a data-toggle='tooltip' data-placement='top' title='Ubah' style='margin-right:5px' class='btn btn-info btn-sm' href='?page=ubah&id=$data[id_user]'>
                            <i class='glyphicon glyphicon-edit'></i>
                          </a>";
              ?>
                <a data-toggle="tooltip" data-placement="top" title="Hapus" class="btn btn-danger btn-sm" href="proses-hapus.php?id=<?php echo $data['id_user']; ?>" onclick="return confirm('Anda yakin ingin menghapus user <?php echo $data['username']; ?>?');">
